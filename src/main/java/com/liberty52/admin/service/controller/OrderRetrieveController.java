...
public class OrderRetrieveController {
    ...
    public String retrieveOrders(@RequestHeader(HttpHeaders.AUTHORIZATION) String adminId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public String retrieveOrderDetail(@RequestHeader(HttpHeaders.AUTHORIZATION) String adminId,
                                      @RequestHeader("LB-Role") String role,
